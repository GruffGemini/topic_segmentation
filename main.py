...
parser.add_argument('-m', '--model', required=True, choices=['mbert', 'MBERT', 'sbert', 'SBERT'],
...
parser.add_argument('-t', '--threshold', required=False, type=float,
                    help='[Optional] A threshold that determines how significant should be the change in dialogue '
                         ...
                         'a single chapter. Default value is 0.5 for SBERT and 0.4 for MBERT.')
...
if not args.threshold:
    args.threshold = 0.4 if common_model_name == CommonModelName.MBERT else 0.5
